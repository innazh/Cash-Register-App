...
namespace Assignment1
{
    ...
    public partial class MainPage : ContentPage
    {
        ...
        void OnListViewItemSelected(object sender, SelectedItemChangedEventArgs e)
        {
            ...
            if (!Quantity.Text.Equals("0")) Total.Text = (selectedItem.Price * Int32.Parse(Quantity.Text)).ToString();
        }
        ...
        void OnListViewItemTapped(object sender, ItemTappedEventArgs e)
        {
            ...
            if (!Quantity.Text.Equals("0")) Total.Text = (tappedItem.Price * Int32.Parse(Quantity.Text)).ToString();
        }
        ...
        public void numberBtn(object sender, EventArgs e)
        {
            ...
            if (!Quantity.Text.Equals("0")) Quantity.Text += b.Text;
